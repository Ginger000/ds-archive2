...
TEST_CASE("List::reverseSimple1", "[weight=2][part=2][valgrind]") {
    List<int> list;
    ...
    REQUIRE(s.str() == "< 1 5 4 3 2 6 >");
}

TEST_CASE("List::reverseSimple2", "[weight=2][part=2][valgrind]") {
    List<int> list;
    ...
    REQUIRE(s.str() == "< 4 3 2 1 5 6 >");
}

TEST_CASE("List::reverseSimple3", "[weight=2][part=2][valgrind]") {
    List<int> list;
    ...
    REQUIRE(s.str() == "< 1 2 6 5 4 3 >");
}

TEST_CASE("List::reverseSimple0", "[weight=2][part=2][valgrind]") {
    List<int> list;
